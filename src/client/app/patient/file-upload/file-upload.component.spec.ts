...
@Component({
  selector: 'test-cmp',
  template: '<sd-file-upload [items]="items"></sd-file-upload>'
})
class TestComponent {
  items: any[] = [
...
export function main() {
  describe('FileUploadComponent (templateUrl)', () => {
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [FileUploadComponent, TestComponent]
    ...
    beforeEach(() => {
      ...
      de = fixture.debugElement.query(By.css('sd-file-upload'));
      el = de.nativeElement;
    });
