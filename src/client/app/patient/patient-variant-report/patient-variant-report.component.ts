...
export class PatientVariantReportComponent {
  ...
  assignmentReport: any = {
    ...
    "taSentToECOGDate": "August 26, 2016 4:36 PM GMT",
    ...
    "noVariantMatch": [
      {
        ...
        "treatmentArmInclusionExclusionDrugs": "Some very long drug description text with the list of all drugs that are included or excluded",
