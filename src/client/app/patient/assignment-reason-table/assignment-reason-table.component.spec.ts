...
@Component({
  selector: 'test-cmp',
  template: '<sd-assignment-reason-table [reasons]="testItems"></sd-assignment-reason-table>'
})
class TestComponent {
...
export function main() {
  describe('AssignmentReasonTableComponent (templateUrl)', () => {
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [AssignmentReasonTableComponent, TestComponent]
